...
<body class="ts-theme-dark">
    <!-- <header class="header">
        <nav class="navbar navbar-expand-lg fixed-top stretched">
            <div class="container-fluid stretched">
                <a class="navbar-brand" target="_blank">
                    <img src="../assets/img/UPES Logo White.png">
                    <img class="csilogo" src="assets/img/csi logo.png" alt="CSI Logo">
                </a>
                <button class="navbar-toggler bg-transparent button2" type="button" data-bs-toggle="collapse"
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" href="../../html/Hackathon 7.0.html">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../../html/Hackathon 7.0.html">About</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../../html/Hackathon 7.0.html">Hackathon</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../../html/Hackathon 7.0.html">Timeline</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../../html/Hackathon 7.0.html">Partners</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../../html/Hackathon 7.0.html">Contact</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="reg-page-header">
        <span>Hackathon 7.0 Registration Form</span>
    </div>
            ...
            <div class="container">
                <div class="form">
                    <form action="submit.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="inputBx">
                            <input type="text"  required="required" value="<?php echo $_COOKIE['userid']; ?>" id="hackathon_id" name="hackathon_id">
                            <!-- <span>Enter Your Team hackathon Id</span> -->
                        </div>

                        <div class="inputBx">
                            <input type="text1" required="required" name="problem_statement">
                            <span>Enter Your Problem Statement</span>
                        </div>
                        <div class="inputBx">
                            <input type="text1" required="required" name="problem_description">
                            <span>Enter Your Problem Description</span>

</div>
                        <div class="inputBx">
                            <input type="text1" required="required" name="expected_outcome">
                            <span>Enter Your Expected Outcome</span>
                        </div>
                    


                        <button class="reg-btn" type="sumbit" name="sumbit" style="color: #fff;">Register</button>
